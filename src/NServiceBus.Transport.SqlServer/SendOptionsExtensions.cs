namespace NServiceBus
{
    ...
    public static class SendOptionsExtensions
    {
        ...
        public static void UseCustomSqlTransaction(this SendOptions options, NpgsqlTransaction transaction)
        {
        ...
        public static void UseCustomSqlConnection(this SendOptions options, NpgsqlConnection connection)
        {
            if (connection == null)
            {
