namespace NServiceBus.Transport.SqlServer.AcceptanceTests.MultiCatalog
{
    ...
    public class When_default_catalog_configured_for_endpoint : MultiCatalogAcceptanceTest
    {
        ...
        {
            public SenderWithCustomCatalog() => _ = EndpointSetup<DefaultServer>(
                                                             b => b.UseTransport<SqlServerTransport>()
                                                                                .DefaultCatalog(Context.SenderCatalog)
                                                                                .ConnectionString(WithCustomCatalog(GetDefaultConnectionString(), Context.ConnectionStringCatalog))
                                                                                .UseCatalogForEndpoint(Context.ReceiverEndpointName, Context.ReceiverCatalog)
                                                                                .Routing()
                                                                                .RouteToEndpoint(typeof(Message), Context.ReceiverEndpointName))
        ...
        {
            public ReceiverWithCustomCatalog() => _ = EndpointSetup<DefaultServer>(
                                                                b => _ = b.UseTransport<SqlServerTransport>()
                                                                          .DefaultCatalog(Context.ReceiverCatalog)
                                                                          .ConnectionString(WithCustomCatalog(GetDefaultConnectionString(), Context.ConnectionStringCatalog))
                                                                          .UseCatalogForEndpoint(Context.SenderEndpointName, Context.SenderCatalog))
