namespace NServiceBus.Transport.SqlServer.AcceptanceTests.MultiCatalog
{
    ...
    public static class SqlUtilities
    {
        ...
        public static async Task DropTable(string catalogName, string schemaName, string tableName, SqlConnection connection, CancellationToken cancellationToken = default)
        {
            ...
            _ = await RunCommand(connection, async (command, token) =>
            {
