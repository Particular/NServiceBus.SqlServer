namespace NServiceBus.AcceptanceTests.Basic
{
    ...
    public class When_receiving_a_poison_message: NServiceBusAcceptanceTest
    {
        ...
        const string CheckDlqMessageCountCommand = "SELECT COUNT(*) FROM [dbo].[DLQ] WHERE [Id] = '{0}'";
        ...
        [Test]
        public void Should_move_the_message_to_dead_letter_queue()
        {
        ...
        public class Receiver : EndpointConfigurationBuilder
        {
            public Receiver()
            {
                EndpointSetup<DefaultServer>(cfg =>
                {
                    ...
                    cfg.UseTransport<SqlServerTransport>().DeadLetterQueue("DLQ");                    
                });
            }
        }
    }
